...
import nino from '../assets/character/cloud.png'
import oiseau from '../assets/character/oiseau.png'
...
function His3() {
  ...
  const storyParagraphs = Array.from({ length: 13 }, (_, i) => ({
    text: t(`nino.paragraph${i + 1}`),
    emotion: t(`nino.emotion${i + 1}`),
  }));
  ...
  return (
    <div>
      ...
      <div className="clouds-container">
        ...
        <img src={nino}  className="cloud  nino" />
        <img src={nino}  className="cloud  nino2" />
        <img src={oiseau}  className="vert  persoO" />
      </div>
    </div>
    </div>
  )
