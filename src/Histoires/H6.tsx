...
import max from '../assets/character/elephant.png'
import flaque from '../assets/character/flaque.png'
...
function His6() {
  ...
  const storyParagraphs = Array.from({ length: 14 }, (_, i) => ({
    text: t(`max.paragraph${i + 1}`),
    emotion: t(`max.emotion${i + 1}`),
  }));
  ...
  return (
    ...
    <div className='histoire'>
      ...
      <div className="clouds-container">
        ...
        <img src={max}  className="vert elephant" />
        <img src={flaque}  className="vert perso2" />
      </div>
    </div>
    </div>
  )
