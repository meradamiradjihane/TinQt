...
import etoile from '../assets/character/etoile.png'
import lune from '../assets/character/croissant-de-lune.png'
import hibou from '../assets/character/hibou.png'
...
function His2() {
  ...
  const storyParagraphs = Array.from({ length: 13 }, (_, i) => ({
    text: t(`stella.paragraph${i + 1}`),
    emotion: t(`stella.emotion${i + 1}`),
  }));
    ...
    <div>
      ...
      <div className="histoire">
        ...
        <div className="clouds-container">
          ...
          <img src={etoile} className="cloud star1" />
          <img src={etoile} className="cloud star2" />
          <img src={lune} className="cloud star" />
          <img src={hibou} className="vert persoH" />
