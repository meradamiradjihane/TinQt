...
import loup from '../assets/character/loup.png'
import oiseau from '../assets/character/hibou.png'
...
function His5() {
  ...
  const storyParagraphs = Array.from({ length: 45 }, (_, i) => ({
    text: t(`wolf.paragraph${i + 1}`),
    emotion: t(`wolf.emotion${i + 1}`),
  }));
  ...
  return (
    ...
    <div className='histoire'>
      ...
      <div className="clouds-container">
        ...
        <img src={loup}  className="vert elephant" />
        <img src={oiseau}  className="vert persohl" />
