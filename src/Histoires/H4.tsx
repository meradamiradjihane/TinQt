...
import leo from '../assets/character/escargot.png'
import lapin from '../assets/character/lapin.png'
...
function His4() {
  ...
  const storyParagraphs = Array.from({ length: 13}, (_, i) => ({
    text: t(`leo.paragraph${i + 1}`),
    emotion: t(`leo.emotion${i + 1}`),
  }));
  ...
  return (
    ...
    <div className='histoire'>
      ...
      <div className="clouds-container">
        ...
        <img src={leo}  className="vert leo" />
        <img src={lapin}  className="vert lapin" />
